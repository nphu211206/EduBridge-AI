...
// ĐÃ SỬA LỖI LOGIC (Kiểm tra !companyData.profile)
...
export default function CompanyProfilePage() {
    ...
    // 3. Kiểm tra dữ liệu (NẾU KHÔNG LỖI, KHÔNG LOADING)
    // Phải kiểm tra cả companyData, companyData.profile, và companyData.jobs
    // để đảm bảo dữ liệu hợp lệ trước khi render.
    if (!companyData || !companyData.profile || !companyData.jobs) {
        // Nếu không có lỗi API, nhưng dữ liệu trả về không hợp lệ, 
        // thì hiển thị lỗi logic thay vì làm "vỡ" trang.
        return <div className="bg-gray-900 min-h-screen flex items-center justify-center p-6"><ErrorMessage message="Dữ liệu hồ sơ công ty không đầy đủ hoặc không hợp lệ." /></div>;
    }

    // Nếu code chạy tới đây, ta chắc chắn companyData.profile và companyData.jobs tồn tại
