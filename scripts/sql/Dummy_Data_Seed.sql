...
BEGIN
    ...
    INSERT INTO [dbo].[Courses] ([InstructorID], [CategoryID], [Title], [Slug], [ShortDescription], [Description], [Level], [Status], [Price], [IsFree], [DurationMinutes], [TotalStudents], [AverageRating], [IsPublic]) VALUES
